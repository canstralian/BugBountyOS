...
class TestPyprojectRuffSection:
    ...
    def test_target_version_is_py313(self, pyproject):
...
class TestPyprojectRuffLintSection:
    ...
    def test_ignore_contains_b008(self, pyproject):
        assert "B008" in pyproject["tool"]["ruff"]["lint"]["ignore"]
...
class TestPyprojectMypySection:
    ...
    def test_python_version_is_313(self, pyproject):
